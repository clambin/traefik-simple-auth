...
| --- | --- |------------------| --- |
| traefik_simple_auth_http_request_duration_seconds | HISTOGRAM | code, host, path |duration of http requests |
| traefik_simple_auth_http_requests_total | COUNTER | code, host, path |total number of http requests |
